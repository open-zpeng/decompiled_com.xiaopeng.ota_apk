...
public class UpgradePresenter implements UpgradeInterfaceBase {
    ...
    public void notifyStart(long j, int i) {
        ...
        setOtaUpgradingProperty();
        sendOtaUpgradingBroadcast();
    ...
    public void notifyStatus(int i) {
        LogUtils.d(TAG, "notifyStatus, %d", Integer.valueOf(i));
        if (i == 0) {
            setOtaIdleProperty();
            sendOtaIdleBroadcast();
            OTAManager.sendStopFotaServiceAndActivity();
    ...
    private void setOtaIdleProperty() {
        LogUtils.d(TAG, "Set ota idle prop");
        SystemPropertiesUtils.setOtaState(0);
    }

    private void setOtaUpgradingProperty() {
        LogUtils.d(TAG, "Set ota upgrading prop");
        SystemPropertiesUtils.setOtaState(1);
    }

    private void sendOtaIdleBroadcast() {
        sendUpgradeStateBroadcast(1);
    }

    private void sendOtaUpgradingBroadcast() {
