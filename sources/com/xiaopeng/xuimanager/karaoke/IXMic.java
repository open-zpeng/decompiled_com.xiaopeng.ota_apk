...
public interface IXMic extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IXMic {
        ...
        public static IXMic asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IXMic)) {
                return (IXMic) queryLocalInterface;
            }
        ...
        public static boolean setDefaultImpl(IXMic iXMic) {
            if (Proxy.sDefaultImpl != null || iXMic == null) {
                return false;
            }
            Proxy.sDefaultImpl = iXMic;
            return true;
        }
