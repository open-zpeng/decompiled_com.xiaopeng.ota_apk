...
public class FeedListUIValue {
    ...
    public static FeedListUIValue fromJson(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            feedListUIValue.source = jSONObject.optString(UserScenarioManager.ACTION_KEY_SOURCE);
    ...
    public static String toJson(FeedListUIValue feedListUIValue) {
        ...
        try {
            ...
            jSONObject.put(UserScenarioManager.ACTION_KEY_SOURCE, feedListUIValue.source);
