...
public abstract class WebViewVersionFragment extends BaseFragment {
    ...
    private int getWindowHeight(int i) {
        ...
        return ((carType.hashCode() == 67044 && carType.equals("D55")) ? (char) 0 : (char) 65535) != 0 ? i == 2 ? VERSION_DETAIL_WINDOW_HEIGHT : NEW_VERSION_WINDOW_HEIGHT : i == 2 ? PORTRAIT_VERSION_DETAIL_WINDOW_HEIGHT : PORTRAIT_NEW_VERSION_WINDOW_HEIGHT;
    }
