...
public class PoiBean implements Parcelable {
    ...
    public PoiBean() {
        this.entrLocation = new PoiLocation(FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU);
        this.exitLocation = new PoiLocation(FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU);
    }
    ...
    public static PoiBean fromJson(String str) {
        ...
        try {
            ...
            if (jSONObject.has("latitude")) {
                str2 = "naviLat";
                poiBean.latitude = jSONObject.optDouble("latitude", FeatureOption.FO_BOOT_POLICY_CPU);
            } else {
                str2 = "naviLat";
            }
            if (jSONObject.has("longitude")) {
                poiBean.longitude = jSONObject.optDouble("longitude", FeatureOption.FO_BOOT_POLICY_CPU);
            }
            ...
            if (jSONObject.has("naviLon")) {
                poiBean.naviLon = jSONObject.optDouble("naviLon", FeatureOption.FO_BOOT_POLICY_CPU);
            }
            if (jSONObject.has(str2)) {
                poiBean.naviLat = jSONObject.optDouble(str2, FeatureOption.FO_BOOT_POLICY_CPU);
            }
            if (jSONObject.has("typeCode")) {
                poiBean.typeCode = jSONObject.optString("typeCode");
            }
            if (jSONObject.has(UserScenarioManager.ACTION_KEY_SOURCE)) {
                poiBean.source = jSONObject.optString(UserScenarioManager.ACTION_KEY_SOURCE);
            }
    ...
    public JSONObject toJson() throws JSONException {
        ...
        jSONObject.put(UserScenarioManager.ACTION_KEY_SOURCE, this.source);
