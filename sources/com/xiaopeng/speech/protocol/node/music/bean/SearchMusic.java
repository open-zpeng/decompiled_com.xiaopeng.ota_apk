...
import com.xiaopeng.xuimanager.businessevent.BusinessEvent;
...
public class SearchMusic extends BaseBean {
    ...
    public static SearchMusic fromJson(JSONObject jSONObject) {
        ...
        try {
            ...
            searchMusic.setModule(jSONObject.optString(BusinessEvent.EXTRA_MODULE));
            ...
            searchMusic.setMode(jSONObject.optString(PowerManager.EXTRA_POWER_SAVE_MODE));
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(BusinessEvent.EXTRA_MODULE, this.module);
            ...
            jSONObject.put(PowerManager.EXTRA_POWER_SAVE_MODE, this.mode);
            return jSONObject;
        } catch (JSONException e) {
            e.printStackTrace();
            return null;
