...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static int computeUInt32SizeNoTag(int i) {
        if ((i & PsoCrypto.Desc.CertKeyVerifyFailed) == 0) {
            return 1;
        }
        if ((i & (-16384)) == 0) {
            return 2;
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                ...
                while ((i & PsoCrypto.Desc.CertKeyVerifyFailed) != 0) {
                    CodedOutputStream.UNSAFE.putByte(this.buffer, j, (byte) ((i & CertificateBody.profileType) | 128));
                    this.position++;
                    i >>>= 7;
                    j = 1 + j;
                }
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                ...
                while ((j & (-128)) != 0) {
                    CodedOutputStream.UNSAFE.putByte(this.buffer, j2, (byte) ((((int) j) & CertificateBody.profileType) | 128));
                    this.position++;
                    j >>>= 7;
                    j2 = 1 + j2;
                }
    ...
    public static final class NioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            while ((i & PsoCrypto.Desc.CertKeyVerifyFailed) != 0) {
                try {
                    this.buffer.put((byte) ((i & CertificateBody.profileType) | 128));
                    i >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            while (((-128) & j) != 0) {
                try {
                    this.buffer.put((byte) ((((int) j) & CertificateBody.profileType) | 128));
                    j >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                long j2 = j;
                while ((i & PsoCrypto.Desc.CertKeyVerifyFailed) != 0) {
                    CodedOutputStream.UNSAFE.putByte(this.buffer, j2, (byte) ((i & CertificateBody.profileType) | 128));
                    i >>>= 7;
                    j2 = 1 + j2;
                }
        ...
        final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                for (long j5 = 0; (j3 & (-128)) != j5; j5 = 0) {
                    CodedOutputStream.UNSAFE.putByte(this.buffer, j4, (byte) ((((int) j3) & CertificateBody.profileType) | 128));
                    j3 >>>= 7;
                    j4 = 1 + j4;
                }
            ...
            while ((j6 & (-128)) != 0) {
                ...
                int i2 = this.position;
                this.position = i2 + 1;
                bArr[i2] = (byte) ((((int) j6) & CertificateBody.profileType) | 128);
                this.totalBytesWritten++;
                j6 >>>= 7;
            }
            byte[] bArr2 = this.buffer;
    ...
    */
    private static boolean supportsUnsafeArrayOperations() {
        /*
            ...
            java.lang.Class[] r4 = new java.lang.Class[r1]     // Catch: java.lang.Throwable -> L31
            java.lang.Class<java.lang.Class> r5 = java.lang.Class.class
            r4[r2] = r5     // Catch: java.lang.Throwable -> L31
            r0.getMethod(r3, r4)     // Catch: java.lang.Throwable -> L31
            sun.misc.Unsafe r0 = com.android.carsdk.protobuf.CodedOutputStream.UNSAFE     // Catch: java.lang.Throwable -> L31
            java.lang.Class r0 = r0.getClass()     // Catch: java.lang.Throwable -> L31
            java.lang.String r3 = "putByte"
            r4 = 3
            java.lang.Class[] r4 = new java.lang.Class[r4]     // Catch: java.lang.Throwable -> L31
            java.lang.Class<java.lang.Object> r5 = java.lang.Object.class
            r4[r2] = r5     // Catch: java.lang.Throwable -> L31
            java.lang.Class r5 = java.lang.Long.TYPE     // Catch: java.lang.Throwable -> L31
            r4[r1] = r5     // Catch: java.lang.Throwable -> L31
            r5 = 2
            java.lang.Class r6 = java.lang.Byte.TYPE     // Catch: java.lang.Throwable -> L31
