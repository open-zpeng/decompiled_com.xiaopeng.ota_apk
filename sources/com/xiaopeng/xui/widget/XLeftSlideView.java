...
public class XLeftSlideView extends XLinearLayout {
    ...
    public XLeftSlideView(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public XLeftSlideView(Context context, @Nullable AttributeSet attributeSet, int i) {
    ...
    */
    ...
    private void upAnim() {
        ...
        if (scrollX == this.mRightCanSlide || scrollX == 0) {
            ...
            if (onDelViewStatusChangeLister != null) {
                onDelViewStatusChangeLister.onStatusChange(scrollX == this.mRightCanSlide);
                return;
            }
            return;
        }
        ...
        if (scrollX >= i / 2) {
            this.mValueAnimator = ValueAnimator.ofInt(scrollX, i);
            this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.widget.XLeftSlideView.1
        ...
        this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.widget.XLeftSlideView.2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                XLeftSlideView.this.scrollTo(((Integer) valueAnimator.getAnimatedValue()).intValue(), 0);
            }
    ...
    public void resetDelStatus() {
        ...
        clearAnim();
        this.mValueAnimator = ValueAnimator.ofInt(scrollX, 0);
        this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.widget.XLeftSlideView.3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                XLeftSlideView.this.scrollTo(((Integer) valueAnimator.getAnimatedValue()).intValue(), 0);
            }
