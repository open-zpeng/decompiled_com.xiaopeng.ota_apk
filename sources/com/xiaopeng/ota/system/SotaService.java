...
public class SotaService extends Service {
    ...
    private SOTAListener mSotaListener = new AnonymousClass3();
    ...
    public void handleAction(Intent intent) {
        ...
        if (hashCode == -2008364448) {
            if (action.equals(Config.ACTION_SOTA_CHECK_UPDATE)) {
                z = true;
            }
            z = true;
        } else if (hashCode != -1454123155) {
            if (hashCode == -517734172 && action.equals(Config.ACTION_SOTA_SERVER_MESSAGE)) {
                z = true;
            }
            z = true;
        } else {
    ...
    /* renamed from: com.xiaopeng.ota.system.SotaService$3  reason: invalid class name */
    /* loaded from: classes2.dex */
    public class AnonymousClass3 extends SOTAListener {
        AnonymousClass3() {
        }
        ...
        public void onInstallStart(String str, int i, int i2, int i3) {
            ...
            ThreadUtils.postBackgroundLong(new Runnable() { // from class: com.xiaopeng.ota.system.-$$Lambda$SotaService$3$4jOgR1cXUCk0McnNIpa6tIAfreA
                @Override // java.lang.Runnable
                public final void run() {
                    SotaService.AnonymousClass3.this.lambda$onInstallStart$0$SotaService$3();
                }
            });
        ...
        public /* synthetic */ void lambda$onInstallStart$0$SotaService$3() {
        ...
        public void onCampaignCheckResult(boolean z) {
            ...
            if (SOTAManager.hasCampaign()) {
                return;
            }
            LogUtils.d(SotaService.TAG, "Check not exist new campaign, stop sota service");
            SotaService sotaService = SotaService.this;
            sotaService.stopServiceAsUser(new Intent(sotaService, SotaService.class), UserHandle.CURRENT);
        }
    }
}
