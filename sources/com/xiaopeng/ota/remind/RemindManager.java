...
public class RemindManager {
    ...
    private void loadLastRemindTime() {
        long j = PreferencesUtils.getLong(this.mContext, KEY_LAST_REMIND_TIME, 0L);
        if (j > 0) {
    ...
    private void updateRemindTime() {
        ...
        PreferencesUtils.putLong(this.mContext, KEY_LAST_REMIND_TIME, this.mLastRemindTime);
    }
    ...
    public synchronized void checkNewByPowerOn() {
        ...
        if (activeCampaign != null && OtaGetCampaignStatus == 7) {
            ...
            if (matchConstantLocation != null) {
                ...
                objArr[1] = remindByRoute ? "success" : "failed";
