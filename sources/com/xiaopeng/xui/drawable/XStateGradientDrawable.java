...
public class XStateGradientDrawable extends Drawable {
    ...
    private void animateColor(int i, int i2) {
        ...
        this.mHeightAnimator.setEvaluator(new ArgbEvaluator());
        this.mHeightAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.drawable.-$$Lambda$XStateGradientDrawable$7A4kQriUQ34lFzDsQly7Hi2ijIQ
