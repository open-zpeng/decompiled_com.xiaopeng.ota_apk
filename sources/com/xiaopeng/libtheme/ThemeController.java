...
public class ThemeController {
    ...
    public static final long DEFAULT_STATE_DELAY = SystemProperties.getLong("persist.sys.theme.settings.delay", (long) Config.HANDLE_DELAY_MILS);
    public static final long DEFAULT_STATE_TIMEOUT = SystemProperties.getLong("persist.sys.theme.settings.timeout", (long) Config.HANDLE_DELAY_MILS);
