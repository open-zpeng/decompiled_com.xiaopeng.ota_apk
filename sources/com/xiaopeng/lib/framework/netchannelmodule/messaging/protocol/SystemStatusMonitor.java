    ...
    private class BroadcastReceiver extends android.content.BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                onNetworkChanged();
            } else if (action.equals(Config.ACTION_SCREEN_ON)) {
        ...
        private void onNetworkChanged() {
            ThreadUtils.postBackground(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.SystemStatusMonitor.BroadcastReceiver.1
                ...
                public void run() {
                    boolean z = true;
                    PowerManager.WakeLock newWakeLock = ((PowerManager) GlobalConfig.getApplicationContext().getSystemService(Car.POWER_SERVICE)).newWakeLock(1, "MQTT");
                    newWakeLock.acquire();
