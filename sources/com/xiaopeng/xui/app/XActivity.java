...
import com.xiaopeng.xui.vui.VuiSceneHelper;
...
public abstract class XActivity extends AppCompatActivity {
    ...
    public VuiSceneHelper getVuiSceneHelper() {
        if (this.mVuiSceneHelper == null) {
            this.mVuiSceneHelper = new VuiSceneHelper();
        }
        return this.mVuiSceneHelper;
    }

    public void initVuiScene(String str, View view) {
        this.mVuiSceneHelper = new VuiSceneHelper();
        this.mVuiSceneHelper.init(getLifecycle(), str, view);
    }
}
