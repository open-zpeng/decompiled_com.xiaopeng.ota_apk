...
public class LottieTask<T> {
    ...
    private void notifyListeners() {
        this.handler.post(new Runnable() { // from class: com.airbnb.lottie.-$$Lambda$LottieTask$hi-nnNZnwrLnM9tiQYr399bB9h4
            @Override // java.lang.Runnable
            public final void run() {
                LottieTask.this.lambda$notifyListeners$0$LottieTask();
            }
        });
    }

    public /* synthetic */ void lambda$notifyListeners$0$LottieTask() {
        LottieResult<T> lottieResult = this.result;
