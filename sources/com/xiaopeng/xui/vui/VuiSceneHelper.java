...
public class VuiSceneHelper implements IVuiSceneListener {
    ...
    public IVuiElementChangedListener mListener = new IVuiElementChangedListener() { // from class: com.xiaopeng.xui.vui.-$$Lambda$VuiSceneHelper$otWdQL9dOe-vIwuXCtugCXd87yo
    ...
    private List<View> getBuildViews() {
        if (this.mBuildViewList == null) {
            ...
            this.mBuildViewList.add(this.mRootView);
        }
