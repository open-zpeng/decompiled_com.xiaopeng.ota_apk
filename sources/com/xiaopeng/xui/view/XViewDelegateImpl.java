...
import com.xiaopeng.xui.utils.XPressedScaleHelper;
...
import com.xiaopeng.xui.widget.XToggleButton_V5;
...
class XViewDelegateImpl extends XViewDelegate {
    ...
    private final XPressedScaleHelper xPressedScaleHelper;
    ...
    public XViewDelegateImpl(@NonNull View view, AttributeSet attributeSet, int i, int i2, Object obj) {
        ...
        this.xPressedScaleHelper = new XPressedScaleHelper(this.mView);
    }
    ...
    public void drawableStateChanged() {
        XPressedScaleHelper xPressedScaleHelper;
        if (FlavorUtils.isV5()) {
            View view = this.mView;
            if (((view instanceof XCheckBox) || (view instanceof XRadioButton) || (view instanceof XButton) || (view instanceof XToggleButton_V5)) && (xPressedScaleHelper = this.xPressedScaleHelper) != null) {
                xPressedScaleHelper.update();
            }
        }
    }
}
