...
import com.xiaopeng.xui.widget.XJumpButton;
import com.xiaopeng.xui.widget.XMenuBar;
import com.xiaopeng.xui.widget.XOffsetView;
...
import com.xiaopeng.xui.widget.XSimpleSlider;
import com.xiaopeng.xui.widget.XSwitch;
import com.xiaopeng.xui.widget.XTabLayout;
import com.xiaopeng.xui.widget.XTabLayout_V5;
...
public class VuiViewUtils {
    ...
    public static VuiElementType getElementType(Object obj) {
        ...
        if (obj instanceof XJumpButton) {
            return VuiElementType.BUTTON;
        }
        if (obj instanceof XMenuBar) {
            return VuiElementType.XTABLAYOUT;
        }
        if (obj instanceof XTabLayout_V5) {
            return VuiElementType.XTABLAYOUT;
        }
        if (obj instanceof XSimpleSlider) {
            return VuiElementType.XSLIDER;
        }
        if (obj instanceof XOffsetView) {
            return VuiElementType.XSLIDER;
        }
