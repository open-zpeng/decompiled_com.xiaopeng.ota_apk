...
public abstract class VuiViewScene implements IVuiViewScene, IVuiSceneListener {
    ...
    private String VUI_SYS_DIALOG_TAG = "SysDialog";
    private String VUI_DIALOG_TAG = "Dialog";
    ...
    @Override // com.xiaopeng.xui.vui.IVuiViewScene
    public void initVuiDialogScene(String str, IVuiEngine iVuiEngine, IVuiSceneListener iVuiSceneListener, int i) {
        if (2008 == i) {
            if (!str.endsWith(this.VUI_SYS_DIALOG_TAG)) {
                str = str + this.VUI_SYS_DIALOG_TAG;
            }
        } else if (!str.endsWith(this.VUI_DIALOG_TAG)) {
            str = str + this.VUI_DIALOG_TAG;
        }
        this.mSceneId = str;
        this.mVuiEngine = iVuiEngine;
        this.isUseNewProtocol = true;
