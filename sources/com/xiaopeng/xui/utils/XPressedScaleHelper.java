...
public class XPressedScaleHelper {
    ...
    private void animate(float f, float f2) {
        ...
        this.valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.utils.-$$Lambda$XPressedScaleHelper$p6D-omXUaUnnlt1-GAqpI346Ygo
