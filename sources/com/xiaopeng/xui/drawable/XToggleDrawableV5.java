...
public class XToggleDrawableV5 extends Drawable {
    ...
    private void animateColor(int i, int i2) {
        ...
        this.mContentAnimator = ValueAnimator.ofInt(i, i2);
        this.mContentAnimator.setEvaluator(new ArgbEvaluator());
        this.mContentAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.drawable.-$$Lambda$XToggleDrawableV5$-G7fm9i54Ug1R4RCIm-Jxz-Nv7U
    ...
    private void animateIndicatorColor(int i, int i2) {
        ...
        this.mIndicatorAnimator = ValueAnimator.ofInt(i, i2);
        this.mIndicatorAnimator.setEvaluator(new ArgbEvaluator());
        this.mIndicatorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.drawable.-$$Lambda$XToggleDrawableV5$segS5EP7ULRiGNxmNuy2DjxT7uY
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
