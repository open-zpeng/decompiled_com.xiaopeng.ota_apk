...
public class XCheckBoxDrawableV5 extends LottieDrawable {
        ...
        if (this.srcId != 0) {
            LottieCompositionFactory.fromRawRes(Xui.getContext(), R.raw.x_checkbox_lottie, null).addListener(new LottieListener<LottieComposition>() { // from class: com.xiaopeng.xui.drawable.checkbox.XCheckBoxDrawableV5.2
                ...
                public void onResult(Throwable th) {
                    Log.d("XCheckBoxDrawableV5", MqttServiceConstants.TRACE_ERROR + th.getMessage());
                }
            });
        }
    }
    ...
    private void animateColor(float f, float f2) {
        ...
        this.mHeightAnimator = ValueAnimator.ofFloat(f, f2);
        this.mHeightAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.drawable.checkbox.-$$Lambda$XCheckBoxDrawableV5$bhJIzOwAKFxHwaSx7qKU_G7A3cw
