...
public class XSeekBar extends AppCompatSeekBar implements VuiView, IVuiElementListener {
    ...
    private void init() {
        ...
        this.mHandleUpChangeRunnable = new Runnable() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XSeekBar$uG5yDLI2zWd0Jz4LIbQfuoFJk-s
    ...
    public boolean onVuiElementEvent(final View view, VuiEvent vuiEvent) {
        ...
        post(new Runnable() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XSeekBar$4oVPfGu1DjOQ4aW3h6x3wKnEer8
            @Override // java.lang.Runnable
            public final void run() {
