...
public enum EcuType {
    BMS(4, "电池管理模块"),
    IPUR(5, "电机控制单元-后驱"),
    IPU(KeyEvent.KEYCODE_NAVIGATE_NEXT, "电机控制单元"),
    IPUF(6, "电机控制单元-前驱"),
    OBC(10, "车载充电器"),
    CCS(KeyEvent.KEYCODE_STEM_2, "充电控制器"),
    DCDC(11, "直流逆变器"),
    EVCC(12, "电动车通信模块"),
    ESP(16, "电子稳定系统"),
    EPBR(17, "电子驻车-右"),
    ...
    IBT(21, "智能刹车系统"),
    XPU(22, "自动驾驶模块"),
    XPUHDMAP(KeyEvent.KEYCODE_COPY, "自动驾驶资源模块"),
    LIDARL(534, "激光雷达-左"),
    LIDARR(790, "激光雷达-右"),
    XPUCNGPMAP(KeyEvent.KEYCODE_CAR_ST_CUSTOM, "城市NGP地图"),
    EPBL(23, "电子驻车-左"),
    TPMS(29, "胎压监测系统"),
    BCM(32, "车身控制器"),
    CGW(33, "网关"),
    ...
    BLER(85, "蓝牙从模块-后"),
    VCU(224, "整车控制器"),
    ACU(KeyEvent.KEYCODE_TV_NETWORK, "安全气囊"),
    APP(256, "SOTA");
