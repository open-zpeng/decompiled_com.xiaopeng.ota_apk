...
public class DataBackupHelper {
    ...
    private boolean isExpiredFile(String str) {
        int lastIndexOf = str.lastIndexOf(OTAConstants.LINKER_UNDER_LINE);
    ...
    private boolean hasTodayFile(File file) {
        ...
        String formatDate10 = DateUtils.formatDate10(System.currentTimeMillis());
        return name.contains(formatDate10.substring(0, formatDate10.indexOf(OTAConstants.LINKER_UNDER_LINE)));
    }

    @NonNull
    private File createNewFile(String str, Context context) {
        String formatDate10 = DateUtils.formatDate10(System.currentTimeMillis());
        return new File(DATA_FILE_DIR + str + "/" + context.getPackageName() + "/" + str + OTAConstants.LINKER_UNDER_LINE + formatDate10 + ".log");
    }
    ...
    private String getTimeFromFile(String str) {
        return str.substring(str.lastIndexOf(OTAConstants.LINKER_UNDER_LINE) - 8, str.lastIndexOf("."));
    }
}
