...
public class XFlexBoxLayout extends FlexboxLayout implements VuiView {
    protected XViewDelegate mXViewDelegate;

    public XFlexBoxLayout(@NonNull Context context) {
        this(context, null);
    }

    public XFlexBoxLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public XFlexBoxLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
