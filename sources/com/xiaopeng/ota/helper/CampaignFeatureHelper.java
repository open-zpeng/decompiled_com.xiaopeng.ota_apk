...
import com.xiaopeng.ota.activity.PortraitInstallActivity;
...
public class CampaignFeatureHelper {
    ...
    public static Class getMainFragmentClass() {
        if (VehicleFeature.isD55() || VersionUtils.isNewVersionDetailOs()) {
    ...
    public static Class getInstallActivity() {
        if (VehicleFeature.isD55()) {
            return PortraitInstallActivity.class;
        }
