...
public class OTAConstants {
    ...
    public static class Server {
        ...
        public static final String OTA_EVENT_URI = "v5/event";
        public static final String OTA_PERMISSION_URI = "v5/verifyKey";
        public static final String OTA_PULL_OS_VERSION_URI = "v5/renew/osVersion";
        public static final String OTA_PUSH_FEEDBACK_URI = "v5/notification/feedback";
        public static final String OTA_REQUEST_DRIVING_ROUTES_URI = "v5/vehicle/routes";
        public static final String OTA_REQUEST_OS_VERSION_URI = "v5/vehicle/osVersion";
        public static final String OTA_SYNC_ECU_URI = "v5/syncEcu";
        public static final String OTA_UPGRADE_URI = "v5/upgrade";
        public static final String OTA_UPLOAD_URI = "v5/upload";
        public static final String OTA_URI_VERSION = "v5";
    }
