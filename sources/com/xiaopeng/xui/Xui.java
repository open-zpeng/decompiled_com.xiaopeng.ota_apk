...
public class Xui {
    ...
    private static IVuiEngine mVuiEngine;
    ...
    public static void setVuiEnable(boolean z, IVuiEngine iVuiEngine) {
        sVuiEnable = z;
        mVuiEngine = iVuiEngine;
    }

    public static IVuiEngine getVuiEngine() {
        return mVuiEngine;
    }
}
