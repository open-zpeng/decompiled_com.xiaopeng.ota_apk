...
import com.xiaopeng.ota.speech.OtaModel;
import com.xiaopeng.ota.speech.OtaQueryModel;
...
import com.xiaopeng.speech.protocol.node.ota.OtaNode;
import com.xiaopeng.speech.protocol.query.ota.OtaQuery;
...
public class OtaService extends Service implements UpdateListener, IOnReceiveListener, IServicePublisher {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.xiaopeng.ota.system.OtaService.6
    ...
    public /* synthetic */ void lambda$onCreate$0$OtaService() {
        ...
        UpgradeExecutorBase[] upgradeExecutorBaseArr = {new CduExecutor(this), new McuExecutor(this, getDir("fota", 0).getAbsolutePath()), new AppExecutor(this)};
    ...
    private void initSpeechCallback() {
        boolean z;
        if (VehicleFeature.isD55() && VersionUtils.isGreaterThanTarget(VersionUtils.D55_APIROUTE_SPEECH_OS_VERSION)) {
            LogUtils.d(TAG, "d55 apiRoute speech observer, no need to register callback");
            z = false;
        } else {
            z = true;
        }
        SpeechClient.instance().init(this, z ? new ConnectManager.OnConnectCallback() { // from class: com.xiaopeng.ota.system.OtaService.5
            @Override // com.xiaopeng.speech.ConnectManager.OnConnectCallback
            public void onConnect(ISpeechEngine iSpeechEngine) {
                LogUtils.d(OtaService.TAG, "Speech client connected");
                SpeechClient.instance().getNodeManager().subscribe(OtaNode.class, new OtaModel());
                SpeechClient.instance().getQueryManager().inject(OtaQuery.class, new OtaQueryModel());
            }

            @Override // com.xiaopeng.speech.ConnectManager.OnConnectCallback
            public void onDisconnect() {
                LogUtils.d(OtaService.TAG, "Speech client disconnected");
                SpeechClient.instance().getNodeManager().unSubscribe(OtaNode.class);
                SpeechClient.instance().getQueryManager().unInject(OtaQuery.class);
            }
        } : null);
        SpeechClient.instance().setAppName("OTA", "OTA");
    }
    ...
    public void onNewCampaign(Campaign campaign) {
        ...
        } else if (ActivityUtils.isForeground(this, CampaignFeatureHelper.getInstallActivity().getName())) {
    ...
    public void onWakeUp(Campaign campaign) {
        ...
        EventPresenter.getInstance().sendWakeUpEvent(campaign.getCampaignId());
    ...
    public void onError(final String str, Exception exc) {
        ...
        if (ActivityUtils.isForeground(this, CampaignFeatureHelper.getInstallActivity())) {
    ...
    public void onCampaignCompleted(long j, boolean z) {
        ...
        if (z) {
            ...
            ActivityHelper.finishActivity(CampaignFeatureHelper.getInstallActivity());
    ...
    private void sendInstallState(int i, String str, String str2, int i2, String str3) {
        ...
        ActivityHelper.startActivity(this, CampaignFeatureHelper.getInstallActivity(), bundle);
    }
    ...
    public void handleAction(Intent intent) {
        ...
        switch (c) {
            ...
            case 1:
                ...
                return;
            case 2:
                if ("Q1".equals(VehicleFeature.getCduType())) {
                    handleLocalIgOn();
                    return;
                }
                return;
        ...
        if (getClass().getName().equals(activityEvent.getClazz().getName())) {
            switch (activityEvent.getAction()) {
                ...
                case CANCEL_AUTO_SCHEDULE:
                    ...
                    this.mUpgradePresenter.cancelSchedule("auto");
    ...
    private void setDefaultSchedule(boolean z) {
        ...
        if (z) {
            ...
            str = "auto";
            if (!TextUtils.isEmpty(OtaGetScheduleTime)) {
    ...
    public String getVcuMode() {
        ...
        sb.append("getVcuMode ");
        sb.append(errorResponse != null ? JsonUtils.toJson(errorResponse) : "null");
    ...
    public String setVcuMode(@Parameter("mode") @NotNull int i) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("setVcuMode ");
        sb.append(errorResponse == null ? "null" : JsonUtils.toJson(errorResponse));
        LogUtils.i(TAG, sb.toString());
        return JsonUtils.toJson(errorResponse);
    }
    ...
    private void checkRepairMode() throws Exception {
        String repairMode = SystemPropertiesUtils.getRepairMode();
        LogUtils.i(TAG, "Repair mode:" + repairMode);
        if (!SystemPropertiesUtils.isRepairMode(repairMode)) {
            throw new IllegalStateException("Not in repair mode");
        }
    }
}
