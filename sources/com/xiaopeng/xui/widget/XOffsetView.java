...
public class XOffsetView extends XLinearLayout implements IVuiElementListener {
    ...
    public XOffsetView(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public XOffsetView(Context context, @Nullable AttributeSet attributeSet, int i) {
    ...
    public VuiElement onBuildVuiElement(String str, IVuiElementBuilder iVuiElementBuilder) {
        try {
            ...
            vuiProps.put(AppMonitorDelegate.MIN_VALUE, this.minValue);
            vuiProps.put(AppMonitorDelegate.MAX_VALUE, this.maxValue);
            vuiProps.put("interval", this.useStep ? this.step : 1);
            vuiProps.put("unit", this.unit);
    ...
    public boolean onVuiElementEvent(View view, VuiEvent vuiEvent) {
        ...
        post(new Runnable() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XOffsetView$DvCsbeAo5AgaW4dGxc30mOn_Gnk
