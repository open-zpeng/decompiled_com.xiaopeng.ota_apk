...
public class UTPageHitHelper {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m110a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m109a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m107a = m107a(obj);
        if (this.A.containsKey(m107a)) {
            return this.A.get(m107a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m107a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m107a);
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m107a = m107a(obj);
            if (m107a != null && m107a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
    ...
    private static String b(Object obj) {
        ...
        return (simpleName == null || !simpleName.toLowerCase().endsWith(UserScenarioManager.SOURCE_ACTIVITY)) ? simpleName : simpleName.substring(0, simpleName.length() - 8);
    }
}
