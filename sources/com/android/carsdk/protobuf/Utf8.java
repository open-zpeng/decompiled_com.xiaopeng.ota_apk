        ...
        final void encodeUtf8Default(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            while (i < length) {
                ...
                if (charAt2 < 128) {
                    ...
                    int i3 = position + 1;
                    byteBuffer.put(position, (byte) ((charAt2 >>> '\f') | CarHvacManager.HVAC_WIND_OFF));
                    position = i3 + 1;
                            ...
                            if (j4 <= j5 - 4) {
                                ...
                                if (i6 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        j3 = 1;
                                        long j6 = j4 + 1;
                                        UNSAFE.putByte(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                        j2 = j5;
                                        long j7 = j6 + 1;
                                        c2 = 128;
                            ...
                            if (position <= limit - 4) {
                                ...
                                if (i3 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        j = 1;
                                        long j4 = position + 1;
                                        UNSAFE.putByte(position, (byte) ((codePoint >>> 18) | 240));
                                        long j5 = j4 + 1;
                                        c2 = 128;
