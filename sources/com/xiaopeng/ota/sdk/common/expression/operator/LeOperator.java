...
public class LeOperator extends LtOperator {
    private EqOperator eq;

    public LeOperator(Object obj, Object obj2) {
        super(obj, obj2);
        this.eq = new EqOperator(obj, obj2);
    }
    ...
    public boolean execute(CondContext condContext) {
        return condContext.containsKey(this.key.toString()) && (this.eq.execute(condContext) || super.execute(condContext));
    }
}
