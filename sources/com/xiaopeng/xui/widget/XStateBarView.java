...
public class XStateBarView extends FrameLayout {
    ...
    public XStateBarView(Context context, AttributeSet attributeSet) {
        ...
        this.y = 0;
        this.alphaView = new XView(context, attributeSet);
        ...
        this.realtimeBlurView = new RealtimeBlurView(context, attributeSet);
        this.realtimeBlurView.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
    ...
    public void bindScrollableView(View... viewArr) {
        ...
        View[] viewArr2 = this.scrollableView;
        if (viewArr2 == null) {
            updateView(0);
            return;
        }
        for (View view : viewArr2) {
            ...
            view.setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XStateBarView$sjoBQtezXodP1sFeblFyEml1y8Y
    ...
    public void updateView(int i) {
        ...
        if (i == 0) {
            new Handler().postDelayed(new Runnable() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XStateBarView$SHdfysB7vy7xMWZs1LnLphj-5mQ
