...
public class EventPresenter {
    ...
    public void sendAutoUpgradeClicked(boolean z, String str) {
        Dictionary dictionary = new Dictionary();
        dictionary.put(KEY_SWITCH, z ? Camera.Parameters.FLASH_MODE_ON : "off");
    ...
    public void sendH5Link(String str, int i, boolean z) {
        ...
        dictionary.put("result", Boolean.valueOf(z));
        if (i > 0) {
    ...
    public void sendIdentityCheckEvent(long j, boolean z, String str) {
        sendEvent(j, "ACTION_IDENTITY_CHECK", str, z ? CampaignEvent.State.OK : CampaignEvent.State.INTERRUPTED);
    }
